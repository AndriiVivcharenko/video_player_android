...
public class Messages {
  ...
  public static class MixWithOthersMessage {
    ...
    private @NonNull Boolean controlAVAudioSesson;
    public @NonNull Boolean getControlAVAudioSesson() { return controlAVAudioSesson; }
    public void setControlAVAudioSesson(@NonNull Boolean setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"controlAVAudioSesson\" is null.");
      }
      this.controlAVAudioSesson = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable Boolean controlAVAudioSesson;
      public @NonNull Builder setControlAVAudioSesson(@NonNull Boolean setterArg) {
        this.controlAVAudioSesson = setterArg;
        return this;
      }
      public @NonNull MixWithOthersMessage build() {
        ...
        pigeonReturn.setControlAVAudioSesson(controlAVAudioSesson);
        return pigeonReturn;
      }
    }
    @NonNull Map<String, Object> toMap() {
      ...
      toMapResult.put("controlAVAudioSesson", controlAVAudioSesson);
      return toMapResult;
    }
    static @NonNull MixWithOthersMessage fromMap(@NonNull Map<String, Object> map) {
      ...
      Object controlAVAudioSesson = map.get("controlAVAudioSesson");
      pigeonResult.setControlAVAudioSesson((Boolean)controlAVAudioSesson);
      return pigeonResult;
    }
  }
